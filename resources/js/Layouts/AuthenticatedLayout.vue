    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <aside class="hidden md:flex w-64 bg-white border-r border-gray-200 flex-col sticky top-0 h-screen">
            ...
            <nav class="flex-1 px-4 py-6 space-y-8 overflow-y-auto">
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <Link 
                            ...
                            <svg class="w-5 h-5 mr-3 transition-colors" :class="route().current('dashboard') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <Link 
                            ...
                            class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all group">
                            <svg class="w-5 h-5 mr-3 transition-colors" :class="route().current('membres.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Finances -->
                <div>
                    <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Trésorerie</p>
                    <div class="space-y-1">
                        <Link 
                            :href="route('contributions.index')" 
                            :class="route().current('contributions.*') ? 'bg-blue-50 text-blue-700 font-bold' : 'text-gray-600 hover:bg-gray-50'"
                            class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all group">
                            <svg class="w-5 h-5 mr-3 transition-colors" :class="route().current('contributions.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <nav class="bg-white border-b border-gray-200 sticky top-0 z-30">
                <div class="mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-between items-center">
                        ...
                        <!-- Menu Utilisateur / Profile Dropdown -->
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="md:hidden border-t border-gray-200 bg-white shadow-lg">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('contributions.index')" :active="route().current('contributions.*')">Contributions</ResponsiveNavLink>
                    </div>
                </div>
            </nav>

            <!-- Header Optionnel de la Page -->
